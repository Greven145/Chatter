...
// Red baseline for #275/#276: QueryDispatcher.cs's non-generic Query<TResult>(IQuery<TResult>[, ctx])
// overload (~lines 27-44) uses `dynamic` + Type.MakeGenericType to resolve and invoke the handler.
// This is a hard Native-AOT-throw site per #275's audit, confirmed here: under the published,
